...
For better practical understanding, see [Math expression language](https://github.com/kpi-tuke/yajco-examples#math-expression-language) in examples or any other more complex example language.
