...
public class Model {
    ...
    private final List<tuke.pargen.annotation.config.Option> options;

    private final Production mainProduction;

    private final Production[] productions;

    public Model(String packageName, String className, Skip[] skips, Map<String, String> tokens, tuke.pargen.annotation.config.Option[] options, Production mainProduction, Production[] productions) {
...
//        }
    ...
    public List<tuke.pargen.annotation.config.Option> getOptions() {
        return options;
    }
