package yajco.semlang.translator;
...
import yajco.model.grammar.semlang.AddElementToCollectionAction;
import yajco.model.grammar.semlang.AssignAction;
import yajco.model.grammar.semlang.ConvertCollectionToArrayAction;
import yajco.model.grammar.semlang.ConvertListToCollectionAction;
import yajco.model.grammar.semlang.ConvertStringToPrimitiveTypeAction;
import yajco.model.grammar.semlang.CreateClassInstanceAction;
import yajco.model.grammar.semlang.CreateCollectionInstanceAction;
import yajco.model.grammar.semlang.CreateEnumInstanceAction;
import yajco.model.grammar.semlang.DefineVariableAction;
import yajco.model.grammar.semlang.LValue;
import yajco.model.grammar.semlang.RValue;
import yajco.model.grammar.semlang.ReferenceResolverRegisterAction;
import yajco.model.grammar.semlang.ReturnAction;
...
//		}
	...
	private String referenceTypeToString(ReferenceType referenceType) {
		return Utilities.getFullConceptClassName(language, referenceType.getConcept());
	}
