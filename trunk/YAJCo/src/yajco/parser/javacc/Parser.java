...
public class Parser implements ParserConstants {
  ...
  yajco.model.pattern.NotationPartPattern _itempatterns_1 = null;
    ...
    {if (true) return yajco.ReferenceResolver.getInstance().register(new yajco.model.PropertyReferencePart( name_1, patterns_1), (Object)name_1, patterns_1);}
    throw new Error("Missing return statement in function");
  }
  ...
  Token _tokenname_1 = null;
    _tokenname_1 = jj_consume_token(NAME);
                                   name_1 = _tokenname_1.image;
    {if (true) return yajco.ReferenceResolver.getInstance().register(new yajco.model.type.ReferenceType( name_1), (Object)name_1);}
    throw new Error("Missing return statement in function");
  }
  ...
  Token _tokenright_2 = null;
    ...
    {if (true) return yajco.ReferenceResolver.getInstance().register(new yajco.model.pattern.impl.Parentheses( left_2, right_2), (Object)left_2, right_2);}
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case PARENTHESES:
        jj_consume_token(PARENTHESES);
    {if (true) return yajco.ReferenceResolver.getInstance().register(new yajco.model.pattern.impl.Parentheses( ));}
        break;
      default:
        jj_la1[3] = jj_gen;
        jj_consume_token(-1);
  ...
  yajco.model.pattern.impl.Associativity associativity_2 = null;
    if (jj_2_2(6)) {
      ...
      jj_consume_token(_41);
    {if (true) return yajco.ReferenceResolver.getInstance().register(new yajco.model.pattern.impl.Operator( intValue_2, associativity_2), (Object)intValue_2, associativity_2);}
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case OPERATOR:
        jj_consume_token(OPERATOR);
        ...
        jj_consume_token(_41);
    {if (true) return yajco.ReferenceResolver.getInstance().register(new yajco.model.pattern.impl.Operator( intValue_1), (Object)intValue_1);}
        break;
      default:
        jj_la1[4] = jj_gen;
        jj_consume_token(-1);
  ...
  yajco.model.pattern.NotationPartPattern _itempatterns_1 = null;
    ...
    {if (true) return yajco.ReferenceResolver.getInstance().register(new yajco.model.LocalVariablePart( name_1, type_1, patterns_1), (Object)name_1, type_1, patterns_1);}
    throw new Error("Missing return statement in function");
  }
  ...
  yajco.model.pattern.PropertyPattern _itempatterns_1 = null;
    ...
    {if (true) return yajco.ReferenceResolver.getInstance().register(new yajco.model.Property( name_1, type_1, patterns_1), (Object)name_1, type_1, patterns_1);}
    throw new Error("Missing return statement in function");
  }
...
//               {if (true) return yajco.model.type.PrimitiveType.STRING;}
  ...
  yajco.model.type.Type componentType_1 = null;
    ...
    {if (true) return yajco.ReferenceResolver.getInstance().register(new yajco.model.type.ListType( componentType_1), (Object)componentType_1);}
    throw new Error("Missing return statement in function");
  }
  ...
  Token _tokenregexp_1 = null;
    ...
    {if (true) return yajco.ReferenceResolver.getInstance().register(new yajco.model.TokenDef( name_1, regexp_1), (Object)name_1, regexp_1);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public yajco.model.pattern.impl.Enum EnumSymbol() throws ParseException {
    ...
    {if (true) return yajco.ReferenceResolver.getInstance().register(new yajco.model.pattern.impl.Enum( ));}
    throw new Error("Missing return statement in function");
  }
  ...
  Token _tokenproperty_1 = null;
    ...
    jj_consume_token(_41);
    {if (true) return yajco.ReferenceResolver.getInstance().register(new yajco.model.pattern.impl.References( name_1, property_1), (Object)name_1, property_1);}
    throw new Error("Missing return statement in function");
  }

  static final public yajco.model.pattern.impl.Identifier IdentifierSymbol() throws ParseException {
    jj_consume_token(IDENTIFIER);
    {if (true) return yajco.ReferenceResolver.getInstance().register(new yajco.model.pattern.impl.Identifier( ));}
    throw new Error("Missing return statement in function");
  }
  ...
  Token _tokenstringValue_1 = null;
    ...
    jj_consume_token(_41);
    {if (true) return yajco.ReferenceResolver.getInstance().register(new yajco.model.pattern.impl.Separator( stringValue_1), (Object)stringValue_1);}
    throw new Error("Missing return statement in function");
  }
  ...
  yajco.model.type.Type componentType_1 = null;
    ...
    {if (true) return yajco.ReferenceResolver.getInstance().register(new yajco.model.type.ArrayType( componentType_1), (Object)componentType_1);}
    throw new Error("Missing return statement in function");
  }

  static final public yajco.model.pattern.impl.printer.NewLine NewLineSymbol() throws ParseException {
    jj_consume_token(NEWLINE);
    {if (true) return yajco.ReferenceResolver.getInstance().register(new yajco.model.pattern.impl.printer.NewLine( ));}
    throw new Error("Missing return statement in function");
  }
  ...
  Token _tokenmaxOccurs_2 = null;
    if (jj_2_3(5)) {
      ...
      jj_consume_token(_41);
    {if (true) return yajco.ReferenceResolver.getInstance().register(new yajco.model.pattern.impl.Range( minOccurs_1), (Object)minOccurs_1);}
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case RANGE:
        jj_consume_token(RANGE);
        ...
        jj_consume_token(_41);
    {if (true) return yajco.ReferenceResolver.getInstance().register(new yajco.model.pattern.impl.Range( minOccurs_2, maxOccurs_2), (Object)minOccurs_2, maxOccurs_2);}
        break;
      default:
        jj_la1[13] = jj_gen;
        jj_consume_token(-1);
  ...
  yajco.model.Notation _itemconcreteSyntax_1 = null;
    ...
    {if (true) return yajco.ReferenceResolver.getInstance().register(new yajco.model.Concept( name_1, parent_1, patterns_1, abstractSyntax_1, concreteSyntax_1), (Object)name_1, parent_1, patterns_1, abstractSyntax_1, concreteSyntax_1);}
    throw new Error("Missing return statement in function");
  }
  ...
  Token _tokenname_1 = null;
    ...
    _tokenname_1 = jj_consume_token(NAME);
                                name_1 = _tokenname_1.image;
    jj_consume_token(_41);
    {if (true) return yajco.ReferenceResolver.getInstance().register(new yajco.model.pattern.impl.Factory( name_1), (Object)name_1);}
    throw new Error("Missing return statement in function");
  }
  ...
  yajco.model.pattern.NotationPattern _itempatterns_1 = null;
    ...
    {if (true) return yajco.ReferenceResolver.getInstance().register(new yajco.model.Notation( parts_1, patterns_1), (Object)parts_1, patterns_1);}
    throw new Error("Missing return statement in function");
  }
  ...
  yajco.model.type.Type componentType_1 = null;
    ...
    {if (true) return yajco.ReferenceResolver.getInstance().register(new yajco.model.type.SetType( componentType_1), (Object)componentType_1);}
    throw new Error("Missing return statement in function");
  }
  ...
  Token _tokenstringValue_1 = null;
    _tokenstringValue_1 = jj_consume_token(STRING_VALUE);
                                                  stringValue_1 = _tokenstringValue_1.image;
    {if (true) return yajco.ReferenceResolver.getInstance().register(new yajco.model.TokenPart( stringValue_1), (Object)stringValue_1);}
    throw new Error("Missing return statement in function");
  }
...
//    {if (true) return yajco.ReferenceResolver.getInstance().register(new yajco.model.Language( tokens_1, skips_1, concepts_1), (Object)tokens_1, skips_1, concepts_1);}
      break;
    case LANGUAGE:
...
//    {if (true) return yajco.ReferenceResolver.getInstance().register(new yajco.model.Language( name_2, tokens_2, skips_2, concepts_2), (Object)name_2, tokens_2, skips_2, concepts_2);}
      break;
    default:
      jj_la1[31] = jj_gen;
      jj_consume_token(-1);
  ...
  static final public yajco.model.pattern.impl.printer.Indent IndentSymbol() throws ParseException {
    ...
    {if (true) return yajco.ReferenceResolver.getInstance().register(new yajco.model.pattern.impl.printer.Indent( ));}
    throw new Error("Missing return statement in function");
  }
