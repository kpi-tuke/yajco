...
public class JavaCCParserGenerator {
    ...
    public void generate() throws IOException {
        try {
            ...
            fo = processingEnv.getFiler().createResource(StandardLocation.SOURCE_OUTPUT, parserJavaCCPackageName, javaccGrammarName);
            ...
            fo = processingEnv.getFiler().createResource(StandardLocation.SOURCE_OUTPUT, parserMainParserPackageName, "ParseException.java");
            writer = fo.openWriter();
