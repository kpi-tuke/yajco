...
public class SemLangToLisaJavaTranslator {
    ...
    public void translateActions(List<Action> actions, Language language, PrintStream writer) {
        ...
        parserPackageName = this.getLanguage().getName() != null ? this.getLanguage().getName() + "." + BeaverParserGenerator.DEFAULT_PACKAGE_NAME : BeaverParserGenerator.DEFAULT_PACKAGE_NAME;
